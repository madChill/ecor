...
const Popup = () => {
  return (
    <div className="App">
      <div className="at-panel-aside__main_ecor">
        ...
        <div className="at-widgets-panel__content">
          ...
          <div className="at-widgets-panel__widget_ecor">
            <div className="at-widget-all-history">
              ...
              <button className="next-btn next-large buy-now-wrap">
                <p>ADD</p>
              </button>
              <button className="buy-now-wrap-sync">
                <p style={{whiteSpace: 'break-spaces'}}>SYNC to Admin</p>
              </button>
            </div>
          </div>
        </div>
        <div className="at-widgets-panel__content_second" />
      </div>
    </div>
  );
};
